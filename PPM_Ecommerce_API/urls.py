...
from ecommerce_cart.views import ShoppingSessionViewSet, CartProductViewSet
from core import views as core_views

router = routers.DefaultRouter()
router.register(r'products', ProductViewSet, basename='products')
router.register(r'products-inventory', ProductInventoryViewSet, basename='productsinventory')
router.register(r'product-scategory', ProductCategoryViewSet, basename='productscategory')
